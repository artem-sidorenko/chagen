...
func Commits() []Commit {
	return []Commit{
		{"041152be02b2d69141d3a8d2278460f4777474f7", time.Unix(2047094647, 0),
			"Merge branch 'pr1' into 'master'"},
		{"1080a10971e4a887ae8a827bb16e0b04801f630b", time.Unix(2047194647, 0),
			"Merge branch 'pr2' into 'master'"},
		{"d72866aa0a25e58b7fb0365fba0fd6791d627451", time.Unix(2047294647, 0),
			"Merge branch 'pr3' into 'master'"},
		{"433a7f849f0a5c21a0f24886ff72a91e1e74888e", time.Unix(2047494647, 0),
			"Merge branch 'pr5' into 'master'"},
		{"e5bc67e0c5d2ed17639a6499d1d0c05d4073dc80", time.Unix(2047594647, 0),
			"Merge branch 'pr6' into 'master'"},
		{"d4c421f840e35fb15ae99683df23caf451db7377", time.Unix(2047694647, 0),
			"Merge branch 'pr7' into 'master'"},
		{"fd81ac08493e550604dd04fa39b9c2eb1907cea6", time.Unix(2047794647, 0),
			"Merge branch 'pr8' into 'master'"},
		{"cc1cf9b1441962bdd6b98a4e09363dffb2037835", time.Unix(2047894647, 0),
			"Merge branch 'pr9' into 'master'"},
		{"9772a06643b77ec1a16646df4bb909c771c09fba", time.Unix(2047994647, 0),
			"Merge branch 'pr10' into 'master'"},
		{"627b94d1e87e938ea140c592f3ebd115d5a98929", time.Unix(2048094647, 0),
			"Merge branch 'pr11' into 'master'"},
		{"c31af03759e2262d99b2c4a7571a8e0115f37d68", time.Unix(2048294647, 0),
			"Merge branch 'pr13' into 'master'"},
		{"9618c791ab1f643aeffb7c5e1abe5877223aaa91", time.Unix(2048394647, 0),
